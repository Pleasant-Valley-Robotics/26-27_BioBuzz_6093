...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = (double) 24 /12221;
        public double lateralInPerTick = 0.001348;

        public double trackWidthTicks = 7373.0;

        // feedforward parameters (in tick units)
        public double kS = 1.26192;
        //0.6729562604215378
        ...
        public double maxProfileAccel = 105;

        // turn profile parameters (in radians)
        public double maxAngVel = Math.PI/2; // shared with patFh
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if (t >= timeTrajectory.duration && error.position.norm() < 0.5 && robotVelRobot.linearVel.norm() < 0.5 || t >= timeTrajectory.duration + 4) {
