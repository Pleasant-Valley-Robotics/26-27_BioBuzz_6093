...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  3655.99; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1120.89; // x position of the perpendicular encoder (in tick units)
